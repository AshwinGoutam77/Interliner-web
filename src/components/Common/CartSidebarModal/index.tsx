  ...
  return (
    <div
      className={`fixed top-0 left-0 z-[99999] overflow-y-auto no-scrollbar w-full h-screen bg-dark/70 ease-linear duration-300
        ${isCartModalOpen ? "block opacity-100" : "hidden opacity-0"}`}>
      <div className="flex items-center justify-end">
        <div className="w-full max-w-[500px] shadow-1 bg-white px-4 sm:px-7.5 lg:px-11 relative modal-content">
          ...
          <div className={`${cartItems.length > 0 ? "h-[66vh]" : "h-[86vh]"} overflow-y-auto no-scrollbar`}>
          ...
          {cartItems.length > 0 && <div className="border-t border-gray-3 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 mt-7.5 sticky bottom-0">
