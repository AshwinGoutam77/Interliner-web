      ...
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        <div className="relative overflow-hidden z-1 rounded-lg bg-[#D0E9F3] p-4 sm:p-7.5 lg:p-10 xl:p-15">
          <div className="max-w-[422px] w-full">
            ...
            <p>Limited-time offer on our premium clothing collection.</p>
          ...
          />
          <Image
            src="/images/banner/banner-image-8.png"
            alt="product"
            className="hidden lg:block absolute right-0 xl:right-[60px] bottom-0 xl:bottom-5 -z-1"
            width={480}
            height={376}
          />
        </div>
